...
final class ScriptAction
{
    ...
    private function output()
    {
        ...
        echo <<<'CODE'
(function(mr){typeof define=="function"&&define.amd?define(mr):mr()})(function(){"use strict";function mr(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var Wf={exports:{}},vr={},Ff={exports:{}},yr={exports:{}};yr.exports;var wv;function q1(){return wv||(wv=1,function(i,r){/**
 * @license React
...
`:pn(a)+"<"+e+`
`+o+pn(a)+`>
`}return e=n.children,t=t.children,typeof e=="string"||typeof e=="number"||typeof e=="bigint"?(l="",(typeof t=="string"||typeof t=="number"||typeof t=="bigint")&&(l=""+t),o+=lc(l,""+e,a+1)):(typeof t=="string"||typeof t=="number"||typeof t=="bigint")&&(o=e==null?o+lc(""+t,null,a+1):o+lc(""+t,void 0,a+1)),o}function Xg(e,t){var n=Gg(e);if(n===null){for(n="",e=e.child;e;)n+=Xg(e,t),e=e.sibling;return n}return pn(t)+"<"+n+`>
...
`,t++)}if(a="",o=e.fiber.pendingProps,e.fiber.tag===6)a=lc(o,e.serverProps,t),t++;else if(l=Gg(e.fiber),l!==null)if(e.serverProps===void 0){a=t;var c=120-2*a-l.length-2,d="";for(y in o)if(o.hasOwnProperty(y)&&y!=="children"){var v=yl(o[y],15);if(c-=y.length+v.length+2,0>c){d+=" ...";break}d+=" "+y+"="+v}a=pn(a)+"<"+l+d+`>
