...
`+gi(n)+$r(t,a)+`
`}return hn(n)+$r(e,a)+`
`}function rh(e){return Object.prototype.toString.call(e).replace(/^\[object (.*)\]$/,function(t,n){return n})}function qr(e,t){switch(typeof e){case"string":return e=JSON.stringify(e),e.length>t?5>t?'"..."':e.slice(0,t-4)+'..."':e;case"object":if(e===null)return"null";if(Ct(e))return"[...]";if(e.$$typeof===Lo)return(t=Ne(e.type))?"<"+t+">":"<...>";var n=rh(e);if(n==="Object"){n="",t-=2;for(var a in e)if(e.hasOwnProperty(a)){var o=JSON.stringify(a);if(o!=='"'+a+'"'&&(a=o),t-=a.length-2,o=qr(e[a],15>t?t:15),t-=o.length,0>t){n+=n===""?"...":", ...";break}n+=(n===""?"":",")+a+":"+o}return"{"+n+"}"}return n;case"function":return(t=e.displayName||e.name)?"function "+t:"function";default:return String(e)}}function yl(e,t){return typeof e!="string"||MS.test(e)?"{"+qr(e,t-2)+"}":e.length>t-2?5>t?'"..."':'"'+e.slice(0,t-5)+'..."':'"'+e+'"'}function uh(e,t,n){var a=120-n.length-e.length,o=[],l;for(l in t)if(t.hasOwnProperty(l)&&l!=="children"){var c=yl(t[l],120-n.length-l.length-1);a-=l.length+c.length+2,o.push(l+"="+c)}return o.length===0?n+"<"+e+`>
`:0<a?n+"<"+e+" "+o.join(" ")+`>
`:n+"<"+e+`
`+n+"  "+o.join(`
`+n+"  ")+`
`+n+`>
`}function ZR(e,t,n){var a="",o=ge({},t),l;for(l in e)if(e.hasOwnProperty(l)){delete o[l];var c=120-2*n-l.length-2,d=qr(e[l],c);t.hasOwnProperty(l)?(c=qr(t[l],c),a+=vl(n)+l+": "+d+`
`,a+=gi(n)+l+": "+c+`
`):a+=vl(n)+l+": "+d+`
`}for(var v in o)o.hasOwnProperty(v)&&(e=qr(o[v],120-2*n-v.length-2),a+=gi(n)+v+": "+e+`
`);return a}function JR(e,t,n,a){var o="",l=new Map;for(y in n)n.hasOwnProperty(y)&&l.set(y.toLowerCase(),y);if(l.size===1&&l.has("children"))o+=uh(e,t,hn(a));else{for(var c in t)if(t.hasOwnProperty(c)&&c!=="children"){var d=120-2*(a+1)-c.length-1,v=l.get(c.toLowerCase());if(v!==void 0){l.delete(c.toLowerCase());var y=t[c];v=n[v];var x=yl(y,d);d=yl(v,d),typeof y=="object"&&y!==null&&typeof v=="object"&&v!==null&&rh(y)==="Object"&&rh(v)==="Object"&&(2<Object.keys(y).length||2<Object.keys(v).length||-1<x.indexOf("...")||-1<d.indexOf("..."))?o+=hn(a+1)+c+`={{
`+ZR(y,v,a+2)+hn(a+1)+`}}
`:(o+=vl(a+1)+c+"="+x+`
`,o+=gi(a+1)+c+"="+d+`
...
Use '@override' decorator for methods overridden by subclass.`)}}function fO(i){return On(i,Zt)||Sr(i,Zt,La({},i[Zt])),i[Zt]}function Or(i){return typeof i=="object"&&typeof i.kind=="string"}function ps(i,r){r.includes(i.kind)||X("The decorator applied to '"+String(i.name)+"' cannot be used on a "+i.kind+" element")}var re=Symbol("mobx administration"),mo=function(){function i(s){s===void 0&&(s="Atom@"+Fn()),this.name_=void 0,this.flags_=0,this.observers_=new Set,this.lastAccessedBy_=0,this.lowestObserverState_=ze.NOT_TRACKING_,this.onBOL=void 0,this.onBUOL=void 0,this.name_=s}var r=i.prototype;return r.onBO=function(){this.onBOL&&this.onBOL.forEach(function(u){return u()})},r.onBUO=function(){this.onBUOL&&this.onBUOL.forEach(function(u){return u()})},r.reportObserved=function(){return dy(this)},r.reportChanged=function(){wn(),hy(this),Rn()},r.toString=function(){return this.name_},al(i,[{key:"isBeingObserved",get:function(){return ln(this.flags_,i.isBeingObservedMask_)},set:function(u){this.flags_=rn(this.flags_,i.isBeingObservedMask_,u)}},{key:"isPendingUnobservation",get:function(){return ln(this.flags_,i.isPendingUnobservationMask_)},set:function(u){this.flags_=rn(this.flags_,i.isPendingUnobservationMask_,u)}},{key:"diffValue",get:function(){return ln(this.flags_,i.diffValueMask_)?1:0},set:function(u){this.flags_=rn(this.flags_,i.diffValueMask_,u===1)}}])}();mo.isBeingObservedMask_=1,mo.isPendingUnobservationMask_=2,mo.diffValueMask_=4;var rd=ii("Atom",mo);function Iv(i,r,s){r===void 0&&(r=el),s===void 0&&(s=el);var u=new mo(i);return r!==el&&TE(u,r),s!==el&&Sy(u,s),u}function dO(i,r){return Yy(i,r)}function hO(i,r){return Object.is?Object.is(i,r):i===r?i!==0||1/i===1/r:i!==i&&r!==r}var ms={structural:dO,default:hO};function li(i,r,s){return xr(i)?i:Array.isArray(i)?Et.array(i,{name:s}):on(i)?Et.object(i,void 0,{name:s}):tl(i)?Et.map(i,{name:s}):Ha(i)?Et.set(i,{name:s}):typeof i=="function"&&!ll(i)&&!Rr(i)?$v(i)?rl(i):wr(s,i):i}function pO(i,r,s){if(i==null||ul(i)||Cs(i)||yo(i)||ga(i))return i;if(Array.isArray(i))return Et.array(i,{name:s,deep:!1});if(on(i))return Et.object(i,void 0,{name:s,deep:!1});if(tl(i))return Et.map(i,{name:s,deep:!1});if(Ha(i))return Et.set(i,{name:s,deep:!1});X("The shallow modifier / decorator can only used in combination with arrays, objects, maps and sets")}function vs(i){return i}function mO(i,r){return xr(i)&&X("observable.struct should not be used with observable values"),Yy(i,r)?r:i}var vO="override";function ys(i){return i.annotationType_===vO}function Er(i,r){return{annotationType_:i,options_:r,make_:yO,extend_:gO,decorate_20223_:bO}}function yO(i,r,s,u){var f;if((f=this.options_)!=null&&f.bound)return this.extend_(i,r,s,!1)===null?0:1;if(u===i.target_)return this.extend_(i,r,s,!1)===null?0:2;if(ll(s.value))return 1;var h=Qv(i,this,r,s,!1);return ma(u,r,h),2}function gO(i,r,s,u){var f=Qv(i,this,r,s);return i.defineProperty_(r,f,u)}function bO(i,r){ps(r,["method","field"]);var s=r.kind,u=r.name,f=r.addInitializer,h=this,p=function(j){var N,R,O,L;return ri((N=(R=h.options_)==null?void 0:R.name)!=null?N:u.toString(),j,(O=(L=h.options_)==null?void 0:L.autoAction)!=null?O:!1)};if(s=="field")return function(g){var j,N=g;return ll(N)||(N=p(N)),(j=h.options_)!=null&&j.bound&&(N=N.bind(this),N.isMobxAction=!0),N};if(s=="method"){var b;return ll(i)||(i=p(i)),(b=this.options_)!=null&&b.bound&&f(function(){var g=this,j=g[u].bind(g);j.isMobxAction=!0,g[u]=j}),i}X("Cannot apply '"+h.annotationType_+"' to '"+String(u)+"' (kind: "+s+"):"+(`
...
`;return _.jsxs(Js,{percent:h,children:[_.jsx(Ks,{children:k("CPU")}),_.jsx(Ws,{title:b,children:_.jsx(jw,{items:i})})]})}),Og={main:"_main_1gdd5_1",item:"_item_1gdd5_12"},Nw=J.memo(({id:i,free:r,total:s})=>_.jsx("div",{className:Og.item,children:_.jsxs(Js,{percent:s?Math.round(r/s*100):0,children:[_.jsx(Ks,{children:`🖴 ${i}`}),_.jsx(Ws,{children:`${jn(r)} / ${jn(s)}`})]})},i)),kw=({data:i})=>{const r=i?.items??[];return _.jsx("div",{className:Og.main,children:r.map(({id:s,free:u,total:f})=>_.jsx(Nw,{free:u,id:s,total:f},s))})},Hw={main:"_main_mc2kq_1"},Lw=({data:i})=>{const{networks:r,timestamp:s}=i,u=bg({items:r,timestamp:s}),f=s-(u?.timestamp||s);return _.jsx("div",{className:Hw.main,children:r.map(({id:h,rx:p,tx:b})=>{if(!(p||b))return null;const g=(u?.items||r).find(R=>R.id===h),j=g?.rx||0,N=g?.tx||0;return _.jsx(_g,{id:h,rateRx:(p-j)/f,rateTx:(b-N)/f,totalRx:p,totalTx:b},h)})})},Eg={main:"_main_18siw_1",name:"_name_18siw_6"},Bw=J.memo(({data:i})=>{const{value:r,max:s}=i,u=s?Math.round(r/s*100):0;return _.jsxs(Js,{percent:u,children:[_.jsx(Ks,{children:`🐏 ${k("Ram")}`}),_.jsx(Ws,{children:`${jn(r)} / ${jn(s)}`})]})}),Vw=J.memo(({data:i})=>{const{value:r,max:s}=i,u=s?Math.round(r/s*100):0;return _.jsxs(Js,{percent:u,children:[_.jsx(Ks,{children:`🐏 ${k("Swap")}`}),_.jsx(Ws,{children:`${jn(r)} / ${jn(s)}`})]})}),$w=J.memo(({id:i})=>{const[r,s]=J.useState(!0),[u,f]=J.useState(0),[h,p]=J.useState(null);J.useEffect(()=>{let I,te=!0;const ne=async()=>{try{const{data:ie,status:Qe}=await oa(`nodes&nodeId=${i}`);if(r&&s(!1),!ie||Qe!==ba){f(Qe);return}p(ie)}finally{te&&(I=setTimeout(ne,2e3))}};return ne(),()=>{te=!1,clearTimeout(I)}},[i,r]);const b=h?.serverStatus??null,g=h?.diskUsage??null,j=h?.networkStats??null,N=h?.serverStatus?.memRealUsage??null,R=h?.serverStatus?.swapUsage??null,O=b?.sysLoad??[],L=b?.cpuUsage??null;return _.jsxs("div",{className:Eg.main,children:[_.jsx("header",{className:Eg.name,children:i}),u!==0&&_.jsx(Tg,{children:fn(k("Error: {{error}}"),{error:u})}),r&&_.jsx(Sg,{height:10}),!r&&b&&_.jsxs(_.Fragment,{children:[L?_.jsx(Uw,{cpuUsage:L,sysLoad:O}):null,N?_.jsx(Bw,{data:N}):null,R?_.jsx(Vw,{data:R}):null,g?_.jsx(kw,{data:g}):null,j?_.jsx(Lw,{data:j}):null]})]})}),qw=be(()=>{const{pollData:i}=Vd,r=i?.nodesIds??[];return r.length?_.jsx(Cn,{id:Vs.id,title:k("Nodes"),children:_.jsx("div",{className:ww.main,children:r.map(s=>_.jsx($w,{id:s},s))})}):null}),Pw=be(()=>{const{pollData:i}=Vd;return(i?.nodesIds??[]).length?_.jsx(Mn,{id:Vs.id,title:k("Nodes")}):null}),Yw={id:Vs.id,content:qw,nav:Pw},Gw={main:"_main_uj7jp_16"},Qd=({keyword:i})=>_.jsx("a",{className:Gw.main,href:`https://www.google.com/search?q=php+${encodeURIComponent(i)}`,rel:"nofollow noreferrer",target:"_blank",children:i}),Xw=J.memo(be(()=>{const{pollData:i}=$d;if(!i)return null;const r=[["Redis",!!i.redis],["SQLite3",!!i.sqlite3],["Memcache",!!i.memcache],["Memcached",!!i.memcached],["Opcache",!!i.opcache],[k("Opcache enabled"),!!i.opcacheEnabled],[k("Opcache JIT enabled"),!!i.opcacheJitEnabled],["Swoole",!!i.swoole],["Image Magick",!!i.imagick],["Graphics Magick",!!i.gmagick],["Exif",!!i.exif],["Fileinfo",!!i.fileinfo],["SimpleXML",!!i.simplexml],["Sockets",!!i.sockets],["MySQLi",!!i.mysqli],["Zip",!!i.zip],["Multibyte String",!!i.mbstring],["Phalcon",!!i.phalcon],["Xdebug",!!i.xdebug],["Zend Optimizer",!!i.zendOptimizer],["ionCube",!!i.ionCube],["Source Guardian",!!i.sourceGuardian],["LDAP",!!i.ldap],["cURL",!!i.curl]];r.slice().sort((u,f)=>{const h=u[0].toLowerCase(),p=f[0].toLowerCase();return h<p?-1:h>p?1:0});const s=i.loadedExtensions||[];return s.slice().sort((u,f)=>{const h=u.toLowerCase(),p=f.toLowerCase();return h<p?-1:h>p?1:0}),_.jsxs(Cn,{id:$s.id,title:k("PHP Extensions"),children:[_.jsx(Qs,{children:r.map(([u,f])=>_.jsx(dn,{label:u,children:_.jsx(Mr,{isEnable:f})},u))}),_.jsx(fl,{children:!!s.length&&_.jsx(dn,{label:k("Loaded extensions"),children:s.map(u=>_.jsx(Qd,{keyword:u},u))})})]})})),Iw=be(()=>{const{pollData:i}=$d;return i?_.jsx(Mn,{id:$s.id,title:k("Ext")}):null}),Qw={id:$s.id,content:Xw,nav:Iw},Zw=be(()=>{const{pollData:i,latestPhpVersion:r,setLatestPhpVersion:s}=Us;J.useEffect(()=>{(async()=>{const{data:p,status:b}=await oa("latestPhpVersion");p?.version&&b===ba&&s(p.version)})()},[s]);const u=i?.phpVersion??"",f=lg(u,r);return _.jsxs(vg,{href:"https://www.php.net/",title:k("Visit PHP.net Official website"),children:[u,f===-1?` ${fn(k("{{latestPhpVersion}} (Latest)"),{latestPhpVersion:r})}`:""]})}),Jw=J.memo(be(()=>{const{pollData:i}=Us;if(!i)return null;const r=[["PHP info",_.jsx(vg,{href:Jy("phpInfoDetail"),target:"_blank",children:k("Detail")},"phpInfoDetail")],[k("Version"),_.jsx(Zw,{},"phpVersion")]],s=[[k("SAPI interface"),i?.sapi],[k("Display errors"),_.jsx(Mr,{isEnable:i?.displayErrors},"displayErrors")],[k("Error reporting"),i.errorReporting],[k("Max memory limit"),i.memoryLimit],[k("Max POST size"),i.postMaxSize],[k("Max upload size"),i.uploadMaxFilesize],[k("Max input variables"),i.maxInputVars],[k("Max execution time"),i.maxExecutionTime],[k("Timeout for socket"),i.defaultSocketTimeout],[k("Treatment URLs file"),_.jsx(Mr,{isEnable:i.allowUrlFopen},"allowUrlFopen")],[k("SMTP support"),_.jsx(Mr,{isEnable:i.smtp},"smtp")]],{disableFunctions:u,disableClasses:f}=i;u.slice().sort(),f.slice().sort();const h=[[k("Disabled functions"),u.length?u.map(p=>_.jsx(Qd,{keyword:p},p)):"-"],[k("Disabled classes"),f.length?f.map(p=>_.jsx(Qd,{keyword:p},p)):"-"]];return _.jsxs(Cn,{id:qs.id,title:k("PHP Information"),children:[_.jsxs(Qs,{children:[r.map(([p,b])=>_.jsx(dn,{label:p,children:b},p)),s.map(([p,b])=>_.jsx(dn,{label:p,children:b},p))]}),_.jsx(fl,{children:h.map(([p,b])=>_.jsx(dn,{label:p,children:b},p))})]})})),Kw=be(()=>{const{pollData:i}=Us;return i?_.jsx(Mn,{id:qs.id,title:k("Ext")}):null}),Ww={id:qs.id,content:Jw,nav:Kw},Fw=i=>{const s=i.reduce((h,p)=>h+p,0)/i.length,f=i.map(h=>{const p=h-s;return p*p}).reduce((h,p)=>h+p,0)/i.length;return Math.sqrt(f)};ut({enforceActions:"observed"});let eR=class{isPing=!1;isPingServerToBrowser=!1;isPingServerToServer=!1;serverToBrowserPingItems=[];serverToServerPingItems=[];constructor(){vt(this)}setIsPing=r=>{this.isPing=r};setIsPingServerToBrowser=r=>{this.isPingServerToBrowser=r};setIsPingServerToServer=r=>{this.isPingServerToServer=r};setServerToBrowserPingItems=r=>{this.serverToBrowserPingItems=r};setServerToServerPingItems=r=>{this.serverToServerPingItems=r};addServerToBrowserPingItem=r=>{this.serverToBrowserPingItems.push(r)};addServerToServerPingItem=r=>{this.serverToServerPingItems.push(r)}};const Zd=new eR,Jd={itemContainer:"_itemContainer_y6c35_12",resultContainer:"_resultContainer_y6c35_27",result:"_result_y6c35_27"},tR=be(()=>{const{serverToBrowserPingItems:i}=Zd,r=i.map(({time:s},u)=>_.jsx("li",{children:`${s} ms`},String(u)));return _.jsx(_.Fragment,{children:r})}),nR=be(()=>{const{serverToBrowserPingItems:i}=Zd,r=i.length,s=i.map(({time:b})=>b),u=r?(s.reduce((b,g)=>b+g,0)/r).toFixed(2):0,f=r?Math.max(...s):0,h=r?Math.min(...s):0,p=Fw(s).toFixed(2);return _.jsx("div",{className:Jd.result,children:fn(k("{{times}} times, min/avg/max/mdev = {{min}}/{{avg}}/{{max}}/{{mdev}} ms"),{times:r,min:h,max:f,avg:u,mdev:p})})}),aR=be(()=>{const{setIsPing:i,setIsPingServerToBrowser:r,addServerToBrowserPingItem:s,isPing:u,isPingServerToBrowser:f,serverToBrowserPingItems:h}=Zd,p=J.useRef(0),b=J.useRef(null),g=J.useCallback(async()=>{const O=Date.now(),{data:L,status:I}=await oa("ping");if(L?.time&&I===ba){const{time:te}=L,ne=Date.now(),ie=te*1e3;s({time:Math.floor(ne-O-ie)}),setTimeout(()=>{if(!b.current)return;const Qe=b.current.scrollTop,He=b.current.scrollHeight;Qe<He&&(b.current.scrollTop=He)},100)}},[s]),j=J.useCallback(async()=>{await g(),p.current=window.setTimeout(async()=>{await j()},1e3)},[g]),N=J.useCallback(async()=>{if(u||f){i(!1),r(!1),clearTimeout(p.current);return}i(!0),r(!0),await j()},[u,f,j,i,r]),R=h.length;return _.jsxs(fl,{children:[_.jsx(dn,{label:k("Server ⇄ Browser"),children:_.jsx(Id,{onClick:N,status:u?Un.Loading:Un.Pointer,children:k(u?"Stop ping":"Start ping")})}),_.jsx(dn,{label:k("Results"),children:_.jsxs("div",{className:Jd.resultContainer,children:[!R&&"-",!!R&&_.jsx("ul",{className:Jd.itemContainer,ref:b,children:_.jsx(tR,{})}),!!R&&_.jsx(nR,{})]})})]})}),oR=J.memo(()=>_.jsx(Cn,{id:Ns.id,title:k("Ping"),children:_.jsx(aR,{})})),iR=()=>_.jsx(Mn,{id:Ns.id,title:k("Ping")}),lR={id:Ns.id,content:oR,nav:iR},Ag={main:"_main_1hf64_14",item:"_item_1hf64_22"},rR=({items:i})=>_.jsx("ul",{className:Ag.main,children:i.map(({id:r,text:s})=>_.jsx("li",{className:Ag.item,children:s},r))}),uR={servers:"_servers_wc9oe_5"};var Kd,wg;function sR(){return wg||(wg=1,Kd=function(){var i=document.getSelection();if(!i.rangeCount)return function(){};for(var r=document.activeElement,s=[],u=0;u<i.rangeCount;u++)s.push(i.getRangeAt(u));switch(r.tagName.toUpperCase()){case"INPUT":case"TEXTAREA":r.blur();break;default:r=null;break}return i.removeAllRanges(),function(){i.type==="Caret"&&i.removeAllRanges(),i.rangeCount||s.forEach(function(f){i.addRange(f)}),r&&r.focus()}}),Kd}var Wd,Rg;function cR(){if(Rg)return Wd;Rg=1;var i=sR(),r={"text/plain":"Text","text/html":"Url",default:"Text"},s="Copy to clipboard: #{key}, Enter";function u(h){var p=(/mac os x/i.test(navigator.userAgent)?"⌘":"Ctrl")+"+C";return h.replace(/#{\s*key\s*}/g,p)}function f(h,p){var b,g,j,N,R,O,L=!1;p||(p={}),b=p.debug||!1;try{j=i(),N=document.createRange(),R=document.getSelection(),O=document.createElement("span"),O.textContent=h,O.ariaHidden="true",O.style.all="unset",O.style.position="fixed",O.style.top=0,O.style.clip="rect(0, 0, 0, 0)",O.style.whiteSpace="pre",O.style.webkitUserSelect="text",O.style.MozUserSelect="text",O.style.msUserSelect="text",O.style.userSelect="text",O.addEventListener("copy",function(te){if(te.stopPropagation(),p.format)if(te.preventDefault(),typeof te.clipboardData>"u"){b&&console.warn("unable to use e.clipboardData"),b&&console.warn("trying IE specific stuff"),window.clipboardData.clearData();var ne=r[p.format]||r.default;window.clipboardData.setData(ne,h)}else te.clipboardData.clearData(),te.clipboardData.setData(p.format,h);p.onCopy&&(te.preventDefault(),p.onCopy(te.clipboardData))}),document.body.appendChild(O),N.selectNodeContents(O),R.addRange(N);var I=document.execCommand("copy");if(!I)throw new Error("copy command was unsuccessful");L=!0}catch(te){b&&console.error("unable to copy using execCommand: ",te),b&&console.warn("trying IE specific stuff");try{window.clipboardData.setData(p.format||"text",h),p.onCopy&&p.onCopy(window.clipboardData),L=!0}catch(ne){b&&console.error("unable to copy using clipboardData: ",ne),b&&console.error("falling back to prompt"),g=u("message"in p?p.message:s),window.prompt(g,h)}}finally{R&&(typeof R.removeRange=="function"?R.removeRange(N):R.removeAllRanges()),O&&document.body.removeChild(O),j()}return L}return Wd=f,Wd}var fR=cR();const dR=mr(fR),hR={main:"_main_18tyj_12"},Fs=({ruby:i,rt:r,isResult:s=!1,...u})=>_.jsxs("ruby",{className:hR.main,"data-is-result":s||void 0,...u,children:[i,_.jsx("rp",{children:"("}),_.jsx("rt",{children:r}),_.jsx("rp",{children:")"})]}),pR={main:"_main_fajqi_1"},mR=({totalMarks:i,total:r})=>_.jsx("div",{className:pR.main,children:_.jsx(Zs,{high:i*.7,low:i*.5,max:i,optimum:i,value:r})}),Oo={main:"_main_18ccs_13",header:"_header_18ccs_22",link:"_link_18ccs_28",marks:"_marks_18ccs_46",sign:"_sign_18ccs_63"},vR=({cpu:i,read:r,write:s,date:u})=>{const f=i+r+s,h=i.toLocaleString(),p=r.toLocaleString(),b=s.toLocaleString(),g=f.toLocaleString(),j=fn("{{cpu}} (CPU) + {{read}} (Read) + {{write}} (Write) = {{total}}",{cpu:h,read:p,write:b,total:g}),N=_.jsx("span",{className:Oo.sign,children:"+"}),R=O=>{O.preventDefault(),O.stopPropagation(),dR(j)};return _.jsxs("button",{className:Oo.marks,onClick:R,title:k("Touch to copy marks"),type:"button",children:[_.jsx(Fs,{rt:"CPU",ruby:h}),N,_.jsx(Fs,{rt:k("Read"),ruby:p}),N,_.jsx(Fs,{rt:k("Write"),ruby:b}),_.jsx("span",{className:Oo.sign,children:"="}),_.jsx(Fs,{isResult:!0,rt:u||"",ruby:g})]})},xg=({header:i,marks:r,maxMarks:s,date:u})=>{const{cpu:f,read:h,write:p}=r;return _.jsxs("div",{className:Oo.main,children:[_.jsx("div",{className:Oo.header,children:i}),_.jsx(vR,{cpu:f,date:u,read:h,write:p}),_.jsx(mR,{total:f+h+p,totalMarks:s})]})};ut({enforceActions:"observed"});let yR=class{benchmarking=!1;maxMarks=0;servers=[];constructor(){vt(this)}setMaxMarks=r=>{this.maxMarks=r};setServers=r=>{this.servers=r};setServer=(r,s)=>{const u=this.servers.findIndex(f=>f.id===r);u!==-1&&(this.servers[u]=s)};setBenchmarking=r=>{this.benchmarking=r}};const zg=new yR,gR=be(()=>{const[i,r]=J.useState(!1),{setMaxMarks:s,maxMarks:u}=zg,[f,h]=J.useState({cpu:0,read:0,write:0}),p=J.useCallback(async j=>{if(j.preventDefault(),j.stopPropagation(),i)return;r(!0);const{data:N,status:R}=await oa("benchmarkPerformance");if(r(!1),R===ba){if(N?.marks){h(N.marks);const O=Object.values(N.marks).reduce((L,I)=>L+I,0);O>u&&s(O);return}bo.open(k("Network error, please try again later."));return}if(N?.seconds&&R===SA){bo.open(fn(k("Please wait {{seconds}}s"),{seconds:N.seconds}));return}bo.open(k("Network error, please try again later."))},[i,u,s]),b=new Date,g=_.jsx(Id,{onClick:p,status:i?Un.Loading:Un.Pointer,children:k("Benchmark my server")});return _.jsx(xg,{date:`${b.getFullYear()}-${b.getMonth()+1}-${b.getDate()}`,header:g,marks:f,maxMarks:u})}),bR=be(()=>{const[i,r]=J.useState(!0),[s,u]=J.useState(!1),{servers:f,setServers:h,setMaxMarks:p,maxMarks:b}=zg;J.useEffect(()=>{(async()=>{r(!0);const{data:N,status:R}=await oa("benchmarkServers");if(r(!1),!N?.length||R!==ba){u(!0);return}u(!1);let O=0;h(N.map(L=>(L.total=L.detail?Object.values(L.detail).reduce((I,te)=>I+te,0):0,L.total>O&&(O=L.total),L)).toSorted((L,I)=>(I?.total??0)-(L?.total??0))),p(O)})()},[h,p]);const g=f.map(({name:j,url:N,date:R,probeUrl:O,binUrl:L,detail:I})=>{if(!I)return null;const{cpu:te=0,read:ne=0,write:ie=0}=I,Qe=O?_.jsx("a",{className:Oo.link,href:O,rel:"noreferrer",target:"_blank",title:k("Visit probe page"),children:_.jsx(FA,{})}):"",He=L?_.jsx("a",{className:Oo.link,href:L,rel:"noreferrer",target:"_blank",title:k("Download speed test"),children:_.jsx(WA,{})}):"",qe=_.jsx("a",{className:Oo.link,href:N,rel:"noreferrer",target:"_blank",title:k("Visit the official website"),children:j});return _.jsx(xg,{date:R,header:_.jsxs(_.Fragment,{children:[qe,Qe,He]}),marks:{cpu:te,read:ne,write:ie},maxMarks:b},j)});return _.jsxs("div",{className:uR.servers,children:[_.jsx(gR,{}),i?[...new Array(5)].map(()=>_.jsx(Sg,{},Math.random())):g,s&&_.jsx(Tg,{children:k("Can not fetch marks data from GitHub.")})]})}),_R=J.memo(()=>_.jsxs(Cn,{id:Ps.id,title:k("Server Benchmark"),children:[_.jsx(rR,{items:[{id:"serverBenchmarkTos",text:k("Different versions cannot be compared, and different time servers have different loads, just for reference.")}]}),_.jsx(bR,{})]})),SR=()=>_.jsx(Mn,{id:Ps.id,title:k("Benchmark")}),TR={id:Ps.id,content:_R,nav:SR},OR=be(({serverUptime:i,serverTime:r})=>{const{days:s,hours:u,mins:f,secs:h}=i,p=fn(k("{{days}}d {{hours}}h {{mins}}min {{secs}}s"),{days:s,hours:u,mins:f,secs:h}),b=[[k("Time"),r],[k("Uptime"),p]];return _.jsx(_.Fragment,{children:b.map(([g,j])=>_.jsx(dn,{label:g,children:j},g))})}),ER=J.memo(({cpuModel:i,serverOs:r,scriptPath:s,publicIpv4:u})=>{const f=[[k("Location (IPv4)"),_.jsx(yg,{ip:u},"serverLocalIpv4")],[k("CPU model"),i??k("Unavailable")],[k("OS"),r??k("Unavailable")],[k("Script path"),s??k("Unavailable")]];return _.jsx(fl,{children:f.map(([h,p])=>_.jsx(dn,{label:h,children:p},h))})}),AR=J.memo(({serverName:i,serverSoftware:r,publicIpv4:s,publicIpv6:u,localIpv4:f,localIpv6:h})=>{const p=[[k("Name"),i??k("Unavailable")],[k("Software"),r??k("Unavailable")],[k("Public IPv4"),s||"-"],[k("Public IPv6"),u||"-"],[k("Local IPv4"),f||"-"],[k("Local IPv6"),h||"-"]];return _.jsx(_.Fragment,{children:p.map(([b,g])=>_.jsx(dn,{label:b,children:g},b))})}),wR=be(()=>{const{pollData:i,publicIpv4:r,publicIpv6:s,setPublicIpv4:u,setPublicIpv6:f}=qd;return J.useEffect(()=>{(async()=>{const{data:p,status:b}=await oa("serverPublicIpv4");p?.ip&&b===ba&&u(p.ip)})()},[u]),J.useEffect(()=>{(async()=>{const{data:p,status:b}=await oa("serverPublicIpv6");p?.ip&&b===ba&&f(p.ip)})()},[f]),i?_.jsxs(Cn,{id:Ys.id,title:k("Server Info"),children:[_.jsxs(Qs,{children:[_.jsx(OR,{serverTime:i.serverTime,serverUptime:i.serverUptime}),_.jsx(AR,{localIpv4:i.localIpv4,localIpv6:i.localIpv6,publicIpv4:r,publicIpv6:s,serverName:i.serverName,serverSoftware:i.serverSoftware})]}),_.jsx(ER,{cpuModel:i.cpuModel,publicIpv4:r,scriptPath:i.scriptPath,serverOs:i.serverOs})]}):null}),RR=be(()=>{const{pollData:i}=qd;return i?_.jsx(Mn,{id:Ys.id,title:k("Info")}):null}),xR={id:Ys.id,content:wR,nav:RR},Dg={main:"_main_raw5t_1",modules:"_modules_raw5t_6"},zR=be(()=>{const{max:i,value:r}=_o.memBuffers;return _.jsx(hi,{isCapacity:!0,max:i,name:k("Memory buffers"),title:k("Buffers are in-memory block I/O buffers. They are relatively short-lived. Prior to Linux kernel version 2.4, Linux had separate page and buffer caches. Since 2.4, the page and buffer cache are unified and Buffers is raw disk blocks not represented in the page cache—i.e., not file data."),value:r})}),DR=be(()=>{const{max:i,value:r}=_o.memCached;return _.jsx(hi,{isCapacity:!0,max:i,name:k("Memory cached"),title:k(`Cached memory is memory that Linux uses for disk caching. However, this doesn't count as "used" memory, since it will be freed when applications require it. Hence you don't have to worry if a large amount is being used.`),value:r})}),CR=be(()=>{const{max:i,value:r}=_o.memRealUsage;return _.jsx(hi,{isCapacity:!0,max:i,name:k("Memory real usage"),title:k('Linux comes with many commands to check memory usage. The "free" command usually displays the total amount of free and used physical and swap memory in the system, as well as the buffers used by the kernel. The "top" command provides a dynamic real-time view of a running system.'),value:r})}),MR=be(()=>{const{max:i,value:r}=_o.swapCached;return i?_.jsx(hi,{isCapacity:!0,max:i,name:k("Swap cached"),value:r}):null}),jR=be(()=>{const{max:i,value:r}=_o.swapUsage;return i?_.jsx(hi,{isCapacity:!0,max:i,name:k("Swap usage"),value:r}):null}),UR=()=>_.jsx(Cn,{id:Gs.id,title:k("Server Status"),children:_.jsx("div",{className:Dg.main,children:_.jsxs("div",{className:Dg.modules,children:[_.jsx(Cw,{}),_.jsx(CR,{}),_.jsx(DR,{}),_.jsx(zR,{}),_.jsx(jR,{}),_.jsx(MR,{})]})})}),NR=be(()=>{const{pollData:i}=_o;return i?_.jsx(Mn,{id:Gs.id,title:k("Info")}):null}),kR={id:Gs.id,content:UR,nav:NR};ut({enforceActions:"observed"});class HR{pollData=null;latestPhpVersion="";constructor(){vt(this)}setPollData=r=>{Dn(r,this.pollData)||(this.pollData=r)};setLatestPhpVersion=r=>{this.latestPhpVersion=r}}const Fd=new HR,LR=be(()=>{const{pollData:i}=Fd;if(!i?.items?.length)return null;const{items:r}=i;return _.jsx(Cn,{id:Xs.id,title:k("Temperature sensor"),children:_.jsx(fl,{children:r.map(({id:s,name:u,celsius:f})=>_.jsx(dn,{title:fn(k("{{sensor}} temperature"),{sensor:u}),children:_.jsx(hi,{isCapacity:!1,max:150,percentTag:"℃",value:f})},s))})})}),BR=be(()=>{const{pollData:i}=Fd;if(!i?.items?.length)return null;const{items:r}=i;return r.length?_.jsx(Mn,{id:Xs.id,title:k("Temperature")}):null}),VR={id:Xs.id,content:LR,nav:BR},Cg={items:[Yw,VR,kR,Aw,yw,lR,xR,Ww,Qw,dw,Sw,TR]},$R=be(()=>{const{setSortedModules:i,availableModules:r}=Gd;return J.useEffect(()=>{const s=fg.getItems(),u=[];for(const f of Cg.items)u.push({id:f.id,priority:Number(s?.[f.id])||Pd.indexOf(f.id)});i(u)},[i]),r.length?_.jsx("div",{className:YA.container,children:r.map(({id:s,content:u})=>_.jsx(u,{},s))}):null}),qR=be(()=>{const{availableModules:i}=Gd,r=i.map(({id:s,nav:u})=>_.jsx(u,{},s));return _.jsx("div",{className:pg.main,children:r})}),PR={main:"_main_nuyl9_6"},YR=()=>_.jsx("div",{className:PR.main,children:"Loading..."}),GR=()=>{const[i,r]=J.useState(!0),{isUpdating:s}=kd;return J.useEffect(()=>{let u,f=!0;const h=async()=>{try{if(s)return;const{data:p,status:b}=await oa("poll");p&&b===200?(sg.setPollData(p),xd.setPollData(p?.config),PA.setPollData(p?.userConfig),Qy.setPollData(p?.database),Ld.setPollData(p?.myInfo),Us.setPollData(p?.phpInfo),zd.setPollData(p?.diskUsage),$d.setPollData(p?.phpExtensions),Bd.setPollData(p?.networkStats),_o.setPollData(p?.serverStatus),qd.setPollData(p?.serverInfo),Vd.setPollData(p?.nodes),Fd.setPollData(p?.temperatureSensor)):bo.open(k("Failed to fetch data. Please try again later.")),i&&r(!1)}finally{f&&(u=setTimeout(h,2e3))}};return h(),()=>{f=!1,clearTimeout(u)}},[i,s]),i?_.jsx(YR,{}):_.jsxs(_.Fragment,{children:[_.jsx(DA,{}),_.jsx($R,{}),_.jsx(yA,{}),_.jsx(qR,{}),_.jsx($A,{})]})};document.addEventListener("DOMContentLoaded",()=>{document.body.innerHTML="",K1.createRoot(document.body).render(_.jsx(GR,{}))})});
